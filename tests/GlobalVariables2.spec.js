...
import {test} from '../global-variables';

// Get the data from Fixtures
test('Verify Admin',async ({page,orangeHRMData}) =>{

    const {url,username,password} = orangeHRMData;
    //Login
    await page.goto(url)
...
test('Verify PIM',async ({page,orangeHRMData}) =>{
